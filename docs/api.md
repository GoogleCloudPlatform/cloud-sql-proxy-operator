...
| `psc` _boolean_ | PSC (optional) Enable connection to the Cloud SQL instance's private service connect endpoint for this instance. May not be used with PrivateIP. Default value is false. |
