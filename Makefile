...
KUBECTL_VERSION=v1.29.2# renovate datasource=github-tags depName=kubernetes/kubernetes
TERRAFORM_VERSION=v1.7.3# renovate datasource=github-tags depName=hashicorp/terraform
...
GOLANGCI_LINT_VERSION=v1.56.2# renovate datasource=go depName=github.com/golangci/golangci-lint/cmd/golangci-lint
