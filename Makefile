...
KUBECTL_VERSION=v1.31.1# renovate datasource=github-tags depName=kubernetes/kubernetes
TERRAFORM_VERSION=v1.8.5# renovate datasource=github-tags depName=hashicorp/terraform

CONTROLLER_TOOLS_VERSION=v0.16.4# renovate datasource=go depName=sigs.k8s.io/controller-tools
