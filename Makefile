...
CERT_MANAGER_VERSION=v1.17.1# renovate datasource=github-tags depName=cert-manager/cert-manager
...
TERRAFORM_VERSION=v1.11.2# renovate datasource=github-tags depName=hashicorp/terraform
