...
KUBECTL_VERSION=v1.37.0# renovate datasource=github-tags depName=kubernetes/kubernetes
TERRAFORM_VERSION=v1.14.3# renovate datasource=github-tags depName=hashicorp/terraform

CONTROLLER_TOOLS_VERSION=v0.22.0# renovate datasource=go depName=sigs.k8s.io/controller-tools
