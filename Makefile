...
CERT_MANAGER_VERSION=v1.16.2# renovate datasource=github-tags depName=cert-manager/cert-manager
...
TERRAFORM_VERSION=v1.10.0# renovate datasource=github-tags depName=hashicorp/terraform
...
GOLANGCI_LINT_VERSION=v1.62.2# renovate datasource=go depName=github.com/golangci/golangci-lint/cmd/golangci-lint
