...
CERT_MANAGER_VERSION=v1.20.2# renovate datasource=github-tags depName=cert-manager/cert-manager
...
TERRAFORM_VERSION=v1.15.1# renovate datasource=github-tags depName=hashicorp/terraform
