...
CERT_MANAGER_VERSION=v1.19.1# renovate datasource=github-tags depName=cert-manager/cert-manager
...
GOLANGCI_LINT_VERSION=v2.6.0# renovate datasource=go depName=github.com/golangci/golangci-lint/cmd/golangci-lint
