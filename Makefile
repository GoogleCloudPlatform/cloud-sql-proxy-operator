...
TERRAFORM_VERSION=v1.9.8# renovate datasource=github-tags depName=hashicorp/terraform
...
GOLANGCI_LINT_VERSION=v1.62.0# renovate datasource=go depName=github.com/golangci/golangci-lint/cmd/golangci-lint
