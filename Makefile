...
CONTROLLER_TOOLS_VERSION=latest # renovate datasource=gomod depName=sigs.k8s.io/controller-tools/cmd/controller-gen
...
ENVTEST_VERSION=v0.13.1 # renovate datasource=gomod depName=sigs.k8s.io/controller-runtime/tools/setup-envtest
