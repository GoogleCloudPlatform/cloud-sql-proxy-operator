...
CERT_MANAGER_VERSION=v1.17.0# renovate datasource=github-tags depName=cert-manager/cert-manager
...
TERRAFORM_VERSION=v1.10.5# renovate datasource=github-tags depName=hashicorp/terraform
