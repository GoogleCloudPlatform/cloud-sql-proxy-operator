...
func (in *AuthProxyWorkloadSpec) DeepCopyInto(out *AuthProxyWorkloadSpec) {
	*out = *in
	...
	if in.ProxyContainer != nil {
		in, out := &in.ProxyContainer, &out.ProxyContainer
		*out = new(ProxyContainerSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Instances != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxyContainerSpec) DeepCopyInto(out *ProxyContainerSpec) {
	*out = *in
	if in.Resources != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxyContainerSpec.
func (in *ProxyContainerSpec) DeepCopy() *ProxyContainerSpec {
	if in == nil {
		return nil
	}
	out := new(ProxyContainerSpec)
...
func (in *TelemetrySpec) DeepCopyInto(out *TelemetrySpec) {
	*out = *in
	if in.PrometheusNamespace != nil {
		in, out := &in.PrometheusNamespace, &out.PrometheusNamespace
		*out = new(string)
		**out = **in
	}
	if in.TelemetryPrefix != nil {
		in, out := &in.TelemetryPrefix, &out.TelemetryPrefix
		*out = new(string)
		**out = **in
	}
	if in.TelemetryProject != nil {
		in, out := &in.TelemetryProject, &out.TelemetryProject
		*out = new(string)
		**out = **in
	}
	if in.TelemetrySampleRate != nil {
		in, out := &in.TelemetrySampleRate, &out.TelemetrySampleRate
		*out = new(int)
		**out = **in
	}
	if in.HttpPort != nil {
	...
	if in.DisableTraces != nil {
		in, out := &in.DisableTraces, &out.DisableTraces
		*out = new(bool)
		**out = **in
	}
